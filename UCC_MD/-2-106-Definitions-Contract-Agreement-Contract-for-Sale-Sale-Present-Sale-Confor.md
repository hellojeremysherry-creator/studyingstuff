...
for a price ( Section 2-401).  A "present sale" means a sale which is accomplished by the making of the 
contract.
...
(4)  "Cancellation" occurs when either party puts an end to the contract for breach by the other and its effect 
is the same as that of "termination" except that the cancelling party also retains any remedy for breach of 
