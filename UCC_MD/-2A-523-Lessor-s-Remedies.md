...
repudiates with respect to a part or the whole, then, with respect to any goods involved, and with respect to 
all of the goods if under an installment lease contract the value of the whole lease contract is substantially 
impaired ( Section 2A-510), the lessee is in default under the lease contract and the lessor may:
...
(c)  withhold delivery of the goods and take possession of goods previously delivered ( Section 2A-
525);
