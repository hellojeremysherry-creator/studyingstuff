...
or governed by another record, or (iii) that rights or obligations with respect to the promise or order are 
stated in another record. A reference to another record does not of itself make the promise or order 
conditional.
(b)  A promise or order is not made conditional (i) by a reference to another record for a statement of rights 
...
instrument fails to countersign the instrument, the failure to countersign is a defense to the obligation of the 
