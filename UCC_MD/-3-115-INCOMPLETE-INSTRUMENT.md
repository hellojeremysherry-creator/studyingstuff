...
which show at the time of signing that it is incomplete but that the signer intended it to be completed by the 
...
enforced according to its terms if it is not completed, or according to its terms as augmented by completion. 
If an incomplete instrument is not an instrument under Section 3-104, but, after completion, the 
requirements of Section 3-104 are met, the instrument may be enforced according to its terms as 
