...
(6)  with respect to any remotely-created consumer item, that the person on whose account the item is 
...
other consideration is obliged to pay the amount due on the item (i) according to the terms of the item at the 
time it was transferred, or (ii) if the transfer was of an incomplete item, according to its terms when 
