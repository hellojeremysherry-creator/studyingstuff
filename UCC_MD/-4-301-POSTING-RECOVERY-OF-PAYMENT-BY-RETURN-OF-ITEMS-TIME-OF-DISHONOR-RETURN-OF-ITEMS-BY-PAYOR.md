...
(1)  returns the item;
(2)  returns an image of the item, if the party to which the return is made has entered into an agreement 
to accept an image as a return of the item and the image is returned in accordance with that 
agreement; or
...
collecting bank or to the clearing house or is sent or delivered in accordance with clearing-house rules; 
or
