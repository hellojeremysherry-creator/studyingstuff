## U.C.C. § 4-302
Uniform Commercial Code (U.C.C.)  >  ARTICLE 4. BANK DEPOSIT  >  PART 3. COLLECTION OF 
## Items: Payor Banks
...
(1)  a demand item, other than a documentary draft, whether properly payable or not, if the bank, in any 
case in which it is not also the depositary bank, retains the item beyond midnight of the banking day of 
receipt without settling for it or, whether or not it is also the depositary bank, does not pay or return the 
