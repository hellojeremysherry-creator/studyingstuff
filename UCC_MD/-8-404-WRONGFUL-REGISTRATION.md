...
(a)  Except as otherwise provided in Section 8-406, an issuer is liable for wrongful registration of transfer if 
the issuer has registered a transfer of a security to a person not entitled to it, and the transfer was 
### registered
(1)  pursuant to an ineffective indorsement or instruction;
(2)  after a demand that the issuer not register transfer became effective under Section 8-403(a) and 
the issuer did not comply with Section 8-403(b);
(3)  after the issuer had been served with an injunction, restraining order, or other legal process 
enjoining it from registering the transfer, issued by a court of competent jurisdiction, and the issuer had 
...
overissue would result, the issuer's liability to provide the person with a like security is governed by Section 
8-210.
