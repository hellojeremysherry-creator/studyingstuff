...
A security interest that is enforceable immediately before this [Act] takes effect but which would be 
...
(2)  remains enforceable thereafter if the security interest becomes enforceable under Section 9-203 
when this [Act] takes effect or within one year thereafter; and
### (3)  becomes perfected
(A)  without further action, when this [Act] takes effect if the applicable requirements for perfection 
